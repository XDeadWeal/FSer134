...
import rtx.kimiko.api.drags.MitosisController.SplitDraw;
...
public final class DragSystem {
    ...
    private void handleRenderFailure(Draggable draggable, Throwable throwable) {
        ...
        if (this.renderFailures.add(string)) {
            Kimiko.LOGGER.error("[DragSystem] Component {} failed to render and was isolated", (Object)string, (Object)throwable);
        }
    }
    ...
    public void applyDrags(JsonObject jsonObject) {
        ...
        for (Draggable draggable : this.elements) {
            ...
            try {
                ...
                Kimiko.LOGGER.debug("[DragSystem] Failed to apply drag for {}: {}", draggable.getClass().getSimpleName(), exception.getMessage());
            }
        }
    }
