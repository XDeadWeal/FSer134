...
public final class RemoteGuiPanelRenderer {
    ...
    private static void renderSidebar(float f, float f2, RemoteGuiPanel remoteGuiPanel, RemoteTheme remoteTheme, float f3) {
        ...
        float f17 = Fonts.SMALL_PIXEL.msdfWidth("KIMIKO", f14);
        ...
        Fonts.SMALL_PIXEL.msdf("KIMIKO", f18 + f16 + f15, f12 - f14 * 0.5f + 0.5f, f14, RemoteGuiPanelRenderer.color(255, 255, 255, 255, f3));
        float f19 = f2 + 34.0f;
        float f20 = f19 + 10.0f;
